...
namespace Chess.Game {
	public class BoardUI : MonoBehaviour {
        ...
        // ruchy możliwe do wykonania z danych koord.
		...
		IEnumerator AnimateMove (Move move, Board board) {
			float t = 0;
			const float moveAnimDuration = 0.17f; // długość animacji WDZ
		...
		void CreateBoardUI () {
			...
			for (int rank = 0; rank < 8; rank++) {
				for (int file = 0; file < 8; file++) {
					...
					// Generowanie bierki dla danego kwadratu
